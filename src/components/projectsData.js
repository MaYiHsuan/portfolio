export const featurettes = [
    ...
    },
    {
        ...
        link: "https://xd.adobe.com/view/d283fa08-1971-4921-ba42-998e9ef60b2d-87d0/",
        imageUrls: [
    ...
    },
    {
        ...
        text4: "#UI/ UX #Prototype #Adobe XD",
        link: "https://xd.adobe.com/view/e95faf20-358e-4d5e-ab53-4a1070feca85-bc0c/",
        imageUrls: [
    ...
    {
        heading: "Cindy Photography Showcase",
        text: "我使用了當前非常熱門的 Webflow 無需代碼的網站設計工具，並採用了響應式設計，確保無論在任何設備上，訪客都能完美呈現我的作品。",
        text2: "這樣的設計不僅提升了用戶體驗，也讓我的攝影作品能更具體而生動地傳達出來。因為我的興趣是旅行和攝影，希望透過這個網站，將我日常生活中紀錄和探索的事物分享給更多人。",
    ...
    {
      heading: "網站前端",
      heading2: "Space tourism/News homepage/Bento grid/Sign up/Social proof section/Preview card",
      text: "為了提升我的前端開發能力，我在 Frontend Mentor 這個專門為前端開發者設計的練習平台上，完成了七個專案",
      text2: "平台模擬了真實開發情境，讓我透過挑戰來自我學習和提升技能，並且幫助我在 UI/UX 設計和響應式網頁開發上取得了顯著的進步，也培養了我解決問題的能力，讓我能夠靈活運用各種開發技巧，讓我在短短的時間內成長迅速。",
      text4: "#Frontend Mentor #網站前端 #響應式設計",
      link: "https://mayihsuan.github.io/Space-tourism-website/#/",
      imageUrls: [
          "https://cdn.jsdelivr.net/gh/MaYiHsuan/Photos/images/CSS/Frame2.png",
          "https://cdn.jsdelivr.net/gh/MaYiHsuan/Photos/images/CSS/Frame3.png",
          "https://cdn.jsdelivr.net/gh/MaYiHsuan/Photos/images/CSS/Frame4.png",
          "https://cdn.jsdelivr.net/gh/MaYiHsuan/Photos/images/CSS/Frame5.png",
          "https://cdn.jsdelivr.net/gh/MaYiHsuan/Photos/images/CSS/Frame6.png",
          "https://cdn.jsdelivr.net/gh/MaYiHsuan/Photos/images/CSS/Frame7.png"
        ],
...
},
{
    ...
    link: "https://www.behance.net/gallery/120912785/_",
    imageUrls: [
...
},
{
    ...
    link: "https://www.behance.net/gallery/117147113/_",
    imageUrls: [
